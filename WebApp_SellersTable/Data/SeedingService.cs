...
using WebApp_SellersTable.Models.Enums;

namespace WebApp_SellersTable.Data
{
    public class SeedingService
    {
        private WebApp_SellersTableContext _context;

        public SeedingService(WebApp_SellersTableContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Ana Marques", "anamarques@msn.com", new DateTime(1985, 6, 21), 1000.00, d2);
            Seller s2 = new Seller(2, "Jose Almeida", "JoseAlmeidas@hotmail.com", new DateTime(1990, 4, 08), 1200.00, d1);
            Seller s3 = new Seller(3, "Paulo Antunes", "PauloAntunes@msn.com", new DateTime(1982, 8, 09), 1600.00, d3);
            Seller s4 = new Seller(4, "Jose Alberto", "JoseAlberto@gmail.com", new DateTime(1987, 9, 05), 1700.00, d4);
            Seller s5 = new Seller(5, "Sofia Simoes", "SofiaSimoes@msn.com", new DateTime(1990, 6, 21), 3500.00, d1);
            Seller s6 = new Seller(6, "Andreia Bento", "AndreiaBento@yahoo.com", new DateTime(1995, 12, 01), 2500.00, d3);
